...
//#define UMEM_SIZE (64 * 1024 * 1024) // 64 MB: for testing with files larger than 4kb to avoid an error
...
int run_multi(const char *filename) {
     ...
     * 
     * Fork up to 8 children at a time, wait for batch to complete,
     * then fork next batch. This limits open file descriptors.
     */
