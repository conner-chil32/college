...
import a1.gameActions.*;
import a1.manualModels.dolHouse;
...
public class MyGame extends VariableFrameRateGame
{
    ...
    public void initializeLights() {
        ...
        light4 = new Light();
        light4.setLocation(house.getWorldUpVector().mul(4.0f));
    ...
    public void initializeGame() {
        ...
        im.associateActionWithAllGamepads(Component.Identifier.Button.A, dolphinToggle, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
