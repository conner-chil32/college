...
public class Camera
{
	...
	/** Will add the inputted yaw angle amount to the existing rotation of the camera */
	...
	/** Will add the inputted pitch angle amount to the existing rotation of the camera */
